...
import { predictRisk, sampleAlerts } from './riskModel'
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const loadAlerts = async () => {
      if (!API_BASE) {
        ...
        setStatus('Running in static demo mode')
        return
      }
      ...
      try {
        ...
        setAlerts(localAlerts)
        setSelectedAlert(localAlerts[0] || null)
        setStatus('Backend unavailable. Running in static demo mode.')
      }
    }
  ...
  const runPrediction = async (e) => {
    ...
    if (!API_BASE) {
      setGeneratedAlert(predictRisk(payload))
      setStatus('Prediction ready in static demo mode')
      return
    }
    ...
    try {
      ...
      setGeneratedAlert(predictRisk(payload))
      setStatus('Prediction API unavailable. Used static demo mode.')
    }
  }
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6">
              <div className="flex items-center justify-between mb-5 gap-4">
                <div>
                  ...
                  <p className="text-slate-600 mt-1">These come from the API when available, with a built-in demo fallback for static deploys.</p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-3xl shadow-sm p-6 text-white">
              ...
              <ol className="mt-4 space-y-2 text-emerald-50 list-decimal list-inside">
                ...
                <li>Backend or built-in demo logic calculates climate risk</li>
